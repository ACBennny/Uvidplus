            ...
            <div class="settingBox">
                <div class="settingNavBdr">
                    <div class="settingNavBox">
                        ...
                        <button type="button" class="settingNavOptBox settSectNavOptBtn active" data-sett-sect="membership">
                ...
                <div class="settCtntBdr">
                    <div class="settCtntBox">
                        <div class="settCtntTab">
                            <div class="settCtntTitle">Viewing Preferences</div>
                            <div class="settCtntSectBdr">
                                <div class="settCtntSectInfo">
                                    <div class="settCtntSectBox">
                                        <div class="settCtntSectTitleBox">
                                            <div class="settCtntSectTitleText">Content Restrictions</div>
                                        </div>
                                        <div class="settCtntSectDescBox">
                                            <div class="settCtntSectDescText"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="settCtntSectAtnBdr">
                                    <div class="settCtntSectAtnBox"></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="topNavBdr dlPgNav">
            <div class="topNavBox">
                ...
                <section class="topNav_section">
                    <button type="button" class="genBtnBox midSolidBtn  openGenMenuModalBtn" data-gen-menu-modal-type="sett_sect_nav">
                        ...
                        <div class="genBtnText">Setting</div>
                    </button>
                </section>
            </div>
        </div>
