...
/***************************************************************
 * This will hold the HTML code for the Anime Section
 * 
                ...
                <div class="specialEp_box">
                    <div class="specialEp_SpImgBdr">
                        <div class="specialEp_SpImgBox">
                            <img src="/Library/Images/other_images/Anime_images/chainsawman1.jpg" alt="Image of SpyxFamily" class="specialEp_SpImg">
                        </div>
                    </div>
                    <div class="specialEp_OtImgBdr">
                        <div class="specialEp_OtImgBox">
                            <img src="/Library/Anime/Watch/SpyXFamily/img/1.jpg" alt="Image of SpyxFamily" class="specialEp_OtImg">
                        </div>
                    </div>
                    <div class="specialEp_DetBdr">
                        <div class="infoBox">
                            ...
                            <p class="watchInfo">
                                ...
                                countries Ostania and Westalis. In spite of their plots, renowned spy and master of disguise "Twilight" fulfills dangerous missions one after 
                                another in the hope that no child will have to experience the horrors of war. In the bustling Ostanian city of Berlint, Twilight dons the alias 
                                of "Loid Forger," an esteemed psychiatrist. However, his true intention is to gather intelligence on prominent politician Donovan Desmond, who 
                                only appears rarely in public at his sons' school: the prestigious Eden Academy. Enlisting the help of unmarried city hall clerk Yor Briar to 
                                act as his wife and adopting the curious six-year-old orphan Anya as his daughter, Loid enacts his master plan. He will enroll Anya in Eden Academy, 
                                where Loid hopes she will excel and give him the opportunity to meet Donovan without arousing suspicion. Although this picture-perfect family is 
                                founded on deception, the Forgers gradually come to understand that the love they share for one another trumps all else.
                            </p>
                            <div class="watchActionBox">
                                <a href="/Library/Anime/SpyxFamily.html" class="watchAction watchEpLink lightSolidBtn" title="Watch ChainsawMan">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="watchActionIcon">
                                        <path d="M464 256A208 208 0 1 0 48 256a208 208 0 1 0 416 0zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256zM188.3 147.1c7.6-4.2 16.8-4.1 24.3 .5l144 88c7.1 4.4 11.5 12.1 11.5 20.5s-4.4 16.1-11.5 20.5l-144 88c-7.4 4.5-16.7 4.7-24.3 .5s-12.3-12.2-12.3-20.9V168c0-8.7 4.7-16.7 12.3-20.9z"/>
                                    </svg>
                                    <span>Watch Now</span>
