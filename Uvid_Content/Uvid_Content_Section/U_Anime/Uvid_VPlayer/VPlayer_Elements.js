...
video_players.forEach(video_player => {
    ...
    <div class="controls-list">
      <div class="controls-left">
        ...
        <span class="icon">
          ...
          <div class="vol_range_box"><input type="range" min="0" max="100" class="volume_range" /></div>
        </span>
  ...
  mainVideo.addEventListener("pause", () => {
    pauseVideo();
         ...
         // This will open the different boxes for the each episode

            //  const popupShow = document.querySelectorAll('.vid-bdr');
            //  const toggleShow = document.querySelectorAll('.main-video');
            // const openShow = document.querySelectorAll('.episodes');
            // const closeShow = document.querySelectorAll('.closeEp');

            //     //opening the episode
            //     var popup = function(popupClick){
            //         popupShow[popupClick].classList.add('vid-bdr-atv');
            //     }

            //     // This starts the show once clicked
            //     var startShow = function(popClick){
            //       toggleShow[popClick].play();
            //     }

            //     // this will pause the show when closed
            //     var stopShow = function(popClick){
            //         toggleShow[popClick].pause();
            //     }

            //     openShow.forEach((openShows, i) => {
            //         openShows.addEventListener("click" , () => {
            //             popup(i);
            //             document.body.classList.add('bodystop');
            //         });
            //     });

            //     //this will close the episode
            //     closeShow.forEach((closeShows, i) => {
            //         closeShows.addEventListener("click" , () => {
            //             popupShow.forEach((popupShows) => {
            //                 popupShows.classList.remove('vid-bdr-atv');
            //                 stopShow(i);
        ...
        //  // This takes user to next episode
        //  function nextEp(){
        //     popupShow[slide_i].classList.remove('vid-bdr-atv');
        //     stopShow(slide_i);
        //     // loadShow(slide_i);
        //     slide_i = (slide_i + 1) % popupShow.length;
        //     popupShow[slide_i].classList.add('vid-bdr-atv');
        //     startShow(slide_i);
        //  }

        //  // This takes user to previous episode
        //  function prevEp(){
        //     popupShow[slide_i].classList.remove('vid-bdr-atv');
        //     stopShow(slide_i);
        //     // loadShow(slide_i);
        //     slide_i = (slide_i - 1 + popupShow.length) % popupShow.length;
        //     popupShow[slide_i].classList.add('vid-bdr-atv');
        //     startShow(slide_i);
        //  }
