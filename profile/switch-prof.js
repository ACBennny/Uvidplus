 ...
 *********************************************************************************************************/
    ...
    {
        loadScriptOnce(
            `/switch-profile/prof-info-lib.js` , 
            `profInfoLibID` ,
            [
                {func_name: `instantiateSwitchProfModal`, ev_name: null},
            ],
            [
                {func_name: `errorLoadingProfInfo`, ev_name: null},
            ],
        );
    }
    ...
    function instantiateSwitchProfModal()
    {
        ...
        function startSwitchProfModal()
        {
            ...
            {
                navProfileImg = document.querySelectorAll(".navBarProfileImage");
                navProfileName = document.querySelector(".navBarProfileNameWatching");

                // Update texts
                navProfileNameText = `${name}`;
                navProfImgSrc = `${frg}`;
                
                // Update the profile image
                if((navProfileImg != undefined))
                {
                    navProfileImg.forEach(img => 
                    {
            ...
            function openEditModal(index, profName, forePic, bcgPic)
            {
                ...
                loadScriptOnce(
                    `/switch-profile/frg-img-lib.js`,
                    `loadFrgImgLibID`,
                    [
                        {func_name: `insertFrgImgModal`, ev_name: null,},
                    ],
                    [
                        {func_name: `errorloadFrgImgLib`, ev_name: null,},
                    ],
                );
                ...
                loadScriptOnce(
                    `/switch-profile/bcg-img-lib.js`,
                    `loadBcgImgLibID`,
                    [
                        {func_name: `insertBcgImgModal`, ev_name: null,},
                    ],
                    [
                        {func_name: `errorloadBcgImgLib`, ev_name: null,},
                    ],
                );
