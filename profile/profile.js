                            ...
                            <div class="profHeaderFrgBox">
                                ...
                                <div class="profHeaderFrgTitleBdr">
                                    ...
                                    <div class="profHeaderFrgTitleAtnBox">
                                        <button type="button" class="genBtnBox lightSolidBtn openEditProfBtn" title="Edit your profile" onclick="notification('notifyBad' , 'Feature currently unavailable')">
            ...
            <div class="topNavBox">
                <section class="topNav_section">
                    <div class="sideNavItemsCardBase topNav_openNavNotify">
                        <button type="button" class="sideNavItemsCardBdr returnToPrevPage" onclick="prev_page_route()">
