                    ...
                    <div class="ftr_bcg_bdr">
                        <div class="ftr_bcg_box">
                            <div class="img_preload_box">
                                ...
                                <img loading="lazy" 
                                    onload="if(!(this.parentElement.classList.contains('loaded'))) this.parentElement.classList.add('loaded')" 
                                    src="${item.show_background}" alt="Background image of ${item.show_title}" class="ftr_bcg_img"
                                >
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="ftr_frg_bdr">
                                <div class="ftr_frg_box">
                                    <div class="img_preload_box">
                                        ...
                                        <img loading="lazy" 
                                            onload="if(!(this.parentElement.classList.contains('loaded'))) this.parentElement.classList.add('loaded')" 
                                            src="${item.show_foreground}" alt="Thumbnail image of ${item.show_title}" class="ftr_frg_img"
                                        >
                                    </div>
                                </div>
                            </div>
