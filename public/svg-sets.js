 ...
 *************************************************************/
    ...
    [
        ...
        {
            icon_name: `serch schedule-search, empty schedule-empty`,
            icon_bold: 
            `
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="">
        ...
        {
            icon_name: `good tick, checkmark check-circle`,
            icon_bold: 
            `
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="">
                    <path fill-rule="evenodd" d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2s10 4.477 10 10m-5.97-3.03a.75.75 0 0 1 0 1.06l-5 5a.75.75 0 0 1-1.06 0l-2-2a.75.75 0 1 1 1.06-1.06l1.47 1.47l2.235-2.235L14.97 8.97a.75.75 0 0 1 1.06 0" clip-rule="evenodd" />
        ...
        },
        {
            ...
            `
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="">
                    <path d="M10.03 8.97a.75.75 0 0 0-1.06 1.06L10.94 12l-1.97 1.97a.75.75 0 1 0 1.06 1.06L12 13.06l1.97 1.97a.75.75 0 0 0 1.06-1.06L13.06 12l1.97-1.97a.75.75 0 1 0-1.06-1.06L12 10.94z" />
	                <path fill-rule="evenodd" d="M12 1.25C6.063 1.25 1.25 6.063 1.25 12S6.063 22.75 12 22.75S22.75 17.937 22.75 12S17.937 1.25 12 1.25M2.75 12a9.25 9.25 0 1 1 18.5 0a9.25 9.25 0 0 1-18.5 0" clip-rule="evenodd" />
                </svg>
            `,
        },
        ...
        },
        {
            ...
            icon_bold: 
            `
                <svg transform="scale(0.80)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 512" class="">
        ...
        {
            icon_name: `open-toggle-password-toggle-open`,
            icon_bold: 
            `
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="">
        ...
        {
            icon_name: `close-toggle-password-toggle-close`,
            icon_bold: 
            `
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="">
        ...
        },
        {
            ...
            `
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="">
                    ...
                    <path d="M0 0h24v24H0z" mask="url(#uvid_solarCardBold0)" />
                </svg>
            `,
            icon_outline: 
            `
